...
namespace MiareFinancial.Models.Courier{
    [PrimaryKey(nameof(CourierScalableBonusId))]
    public class CourierScalableBonus : MiareBaseModel
    {
        //Identifier
        public int CourierScalableBonusId{get; set;}
        //Key Identifire
        ...
        public CourierScalableBonus(){
        }
        public CourierScalableBonus(List<string> recordFromCsv){
